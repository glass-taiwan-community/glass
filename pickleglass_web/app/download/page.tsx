  ...
  return (
    <div className="p-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Download pickleglass</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Desktop</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">Windows, macOS, Linux</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Mobile</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">iOS, Android</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-8 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Tablet</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">iPad, Android Tablet</p>
        ...
        <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-950 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Mobile</h4>
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Having issues? Check out our <a href="/help" className="text-blue-600 dark:text-blue-400 hover:text-blue-700">Help Center</a>.
          </p>
        </div>
      </div>
    </div>

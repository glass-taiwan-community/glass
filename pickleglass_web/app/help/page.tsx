  ...
  return (
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-8">Help Center</h1>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
            ...
            <div className="space-y-3">
              <details className="text-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-2 pl-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Community</h2>
            </div>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
        ...
        <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-950/40 rounded-lg">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">💡 Tip</h3>

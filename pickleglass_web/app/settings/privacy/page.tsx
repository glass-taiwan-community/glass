    ...
    <div className="bg-stone-50 dark:bg-gray-950 min-h-screen">
      <div className="px-8 py-8">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 flex flex-col">
            ...
            <div className="flex justify-end mt-6">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 hover:dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md text-sm font-medium transition-colors"
              >
                Privacy

const LATEST_SCHEMA = {
    users: {
        columns: [
            ...
            { name: 'save_ask_screenshots', type: 'INTEGER DEFAULT 0' },
    ...
    ai_messages: {
        columns: [
            ...
            // Filename (not absolute path) of a saved screen-only Ask screenshot, in
            // userData/ask-screenshots. Null for text/voice/summary asks.

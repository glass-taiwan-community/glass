...
module.exports = {
  initialize() {
    ...
    ipcMain.handle('open-personalize-page', () => windowManager.openWebDashboard());
    ...
    ipcMain.handle('adjust-window-height', (event, { winName, height, animated }) => windowManager.adjustWindowHeight(winName, height, animated));
  },
